...
{	
	...
	mail($mail,"Consulta de Producto","Te responderemos a la brevedad tu consulta:"." ".$consulta,"From:contacto@lokales.com.ar");
	mail("...@hotmail.com","GRAVITAL CONSULTA",$consulta,"From:".$mail);
