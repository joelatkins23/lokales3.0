...
$mensajes=mysql_query("SELECT * FROM mensajes_internos, mensajes_internos_destinatarios, usuarios WHERE usuarios.id_usuario=mensajes_internos.id_usuario_rem AND mensajes_internos.id_mensaje=mensajes_internos_destinatarios.id_mensaje AND mensajes_internos_destinatarios.id_usuario='$id_usuario'",$link);
