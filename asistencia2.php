...
// $query = mysqli_query($mysqli,"SELECT * FROM registrados WHERE actividad = " . $fetch_actividad['id_actividad'] . AND "mes_pagado between now() - interval 40 day" . " ORDER BY apellido ASC");
		//$query = mysqli_query($mysqli,"SELECT * FROM registrados WHERE actividad = " . $fetch_actividad['id_actividad'] . AND CURDATE()-registrados.mes_pagado< DATE_SUB("mes_pagado", INTERVAL 40 DAY) . " ORDER BY apellido ASC");
		//select * from registrados where actividad = " . $fetch_actividad['id_actividad'] . " and mes_pagado BETWEEN DATE_ADD(CURDATE(), INTERVAL -45 DAY) and CURDATE();
...
{
    $query = mysqli_query($mysqli,"SELECT * FROM actividad ORDER BY nombre");
